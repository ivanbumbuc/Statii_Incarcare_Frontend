...
import {Checkbox, InputLabel, Link, TablePagination} from '@mui/material';
                ...
                >
                    ...
                    >
                        ...
                        <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                            ...
                            <Grid item marginLeft={1}>
                                {userInfo.is_admin=="true" ? <CheckCircleIcon color="secondary"/> : <CancelIcon color="error"/>}
                            </Grid>
                        </Grid>
                        <Grid container direction="row" alignItems="center" justifyContent="flex-start">
                            <Grid item>
                            ...
                            <Grid item marginLeft={1}>
                                {userInfo.is_charging=="true" ? <CheckCircleIcon color="secondary"/> : <CancelIcon color="error"/>}
                            </Grid>
                        </Grid>
